    ...
    <div>
      {showSidebar ? (
        <div
          ...
          className="fixed z-50 ml-72 mt-80 text-[#19B0E7] text-2xl focus:outline-none transform cursor-pointer transition duration-5000"
          onClick={toggleSidebar}>
          {hovered ? (
            <FaArrowLeft title="Close Sidebar" style={{ fontSize: "2rem" }} />
          ) : (
        ...
        <FaArrowRight
          onClick={toggleSidebar}
          className="fixed z-50 ml- mt-80  text-[#19B0E7] text-2xl focus:outline-none transform cursor-pointer"
          style={{ fontSize: "2rem" }}
          title="Open Sidebar"
        />
      )}
